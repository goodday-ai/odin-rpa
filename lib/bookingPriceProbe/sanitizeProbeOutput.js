...
const SENSITIVE_RE = /(cookie|authorization|bearer|token|secret|password|email|phone|mobile|tel|姓名|電話|信箱|訂單編號|order|order_serial|order_no|uuid|identity)/i;
...
const SAFE_STRING_KEYS = new Set([
  ...
  "type", "topLevelType", "origin", "path", "outputPath",
]);
