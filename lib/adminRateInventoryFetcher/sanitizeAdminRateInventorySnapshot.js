...
const SAFE_STRING_KEYS = new Set([
  "tenant", "tenantKey", "mode", "hotelId", "displayName", "rangeStart", "rangeEnd", "currency", "source", "capturedAt", "startedAt", "finishedAt", "stoppedReason", "origin", "path", "sourcePath", "date",
  "salesUnitId", "salesUnitName", "roomTypeId", "roomTypeName", "planId", "planName", "planItemId", "planItemName", "ratePlanId", "ratePlanName", "packageId", "packageName", "policyName", "sourcePlanItemKey", "channel", "reason", "topLevelType",
]);
